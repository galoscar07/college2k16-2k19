...
class Movie(object):
    ...
    '''
    def __init__(self,entityId,title,genre,description):
        """
    ...
    def __str__(self, *args, **kwargs):
        return "Movie id: #{0}, Title: {1}, Genre: {2}, Description: {3}".format(self.entityId, self.title, self.genre,
                                                                                 self.description)
...
class Rental(object):
    ...
    """
    def __init__(self,entityId,movieId,clientId,rentDate,dueDate,returnedDate):
        """
    ...
    def __str__(self, *args, **kwargs):
        return "Rental Id: #{0}, Movie Id: {1}, Client Id: {2}, Rented Date: {3}, Due Date:{4}, Returned Date: {5})".format(
            self.entityId, self.movieId, self.clientId, self.rentDate, self.dueDate, self.returnedDate)
