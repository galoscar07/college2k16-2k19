...
public:
	...
	void addSongToRepository(const std::string& type, const std::string& artist, const std::string& title, double minutes, double seconds, const std::string& source, double size = 0);
