...
public:
	...
	public:
		...
		iterator operator++(int dummy) { iterator i = *this; ptr++; return i; }
		bool operator !=(const iterator &i) { return i.ptr != this->ptr; }
		T& operator*() { return *ptr; }
		T* operator->() { return ptr; }
	};

	iterator begin() { return this->elems; }
	iterator end() { return this->elems + size; }
};
