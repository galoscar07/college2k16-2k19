...
void writeSpaceShips()
{
	...
	vector<Spaceship> spaceships = { Spaceship{"Death Star", "Darth Vader", "dreadnought"}, Spaceship{"Prometheus", "George Hammond", "battlecruiser"} };
...
int main()
{
	...
	while (!(cin >> val))
	{
		...
		cin.ignore(100, '\n');	// ignore: either 100 characters or all characters up to encountering '\n'
	}
