...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_StudentsWidget_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_StudentsWidget_t qt_meta_stringdata_StudentsWidget = {
    {
QT_MOC_LITERAL(0, 0, 14) // "StudentsWidget"
...
static const uint qt_meta_data_StudentsWidget[] = {
...
const QMetaObject StudentsWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_StudentsWidget.data,
      qt_meta_data_StudentsWidget,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *StudentsWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_StudentsWidget.stringdata0))
        return static_cast<void*>(const_cast< StudentsWidget*>(this));
