...
class Interpreter {
    public static void main(String[] args) {
        ...
        Statement ex4 = new CompoundStatement(new AssignStatement("v",new ConstExpression(10)),new CompoundStatement(new HeapAllocStatement("a",
                new ConstExpression(22)),new CompoundStatement(new ForkStatement(new CompoundStatement(new HeapWritingStatement("a",
                new ConstExpression(30)),new CompoundStatement(new AssignStatement("v",new ConstExpression(32)),
                new CompoundStatement(new PrintStatement(new VariableExpression("v")),new AssignStatement("a",new ConstExpression(15)))))),
                new CompoundStatement(new PrintStatement(new VariableExpression("v")),new AssignStatement("a",new ConstExpression(20))))));

        IExecStack<Statement> es4 = new ExecStack<>();
        es4.push(ex4);
        IDictionary<String, Integer> dict4 = new Dictionary<>();
        IList<Integer> list4 = new MyList<>();
        IDictionary<Integer, Tuple<String, BufferedReader>> ft4 = new Dictionary<>();
        IHeap<Integer, Integer> h4 = new Heap<>();
        ProgramState prg4 = new ProgramState(1, es4, dict4, list4, ft4, h4);
        IProgramStateRepository repo4 = new ProgramStateRepository("output/log1.txt");
