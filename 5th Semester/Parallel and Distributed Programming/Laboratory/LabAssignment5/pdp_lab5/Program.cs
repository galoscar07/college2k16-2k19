...
namespace ppd_lab5
{
    ...
    public class Program
    {
        ...
        private static List<string> hostNames = new List<string>() { "cs.ubbcluj.ro" };

        private static List<String> response = new List<String>() { String.Empty };
        ...
        private static async void StartClient(string hostName, int i)
        {
            ...
            try
            {
                ...
                // The name of the   
                // remote device is "cs.ubbcluj.ro".  
        ...
        private static int ParseHttpResponse(string str)
        {
            ...
            for (i = 1; i < splitted.Length; i++)
            {
                ...
                if (string.Compare(current[0], "Content-Length", StringComparison.Ordinal) == 0)
                {
