...
public class Main {
    ...
    static String[] adds = {"/Users/galoscar/Documents/University&Shits/Parallel and Distributed Programming/Laboratory/LabAssignment3 Java/add.in"};
    static String[] mults = {"/Users/galoscar/Documents/University&Shits/Parallel and Distributed Programming/Laboratory/LabAssignment3 Java/mult.in"};
    static int n, m;
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        try (Writer fileWriter = new BufferedWriter(new OutputStreamWriter(
                new FileOutputStream("/Users/galoscar/Documents/University&Shits/Parallel and Distributed Programming/Laboratory/LabAssignment3 Java/filename.txt"), "utf-8"))) {
            for (String add : adds) {
                for (int aTP : TP) {
                    for (int aT : T) {
                        double time = solve(add, aTP, aT, true, new AdditionerFactory());
            ...
            for (String mult : mults) {
                for (int aTP : TP) {
                    for (int aT : T) {
                        double time = solve(mult, aTP, aT, true, new MultiplierFactory());
